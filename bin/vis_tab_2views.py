...
class Vis(QWidget):
    ...
    def __init__(self, nanohub_flag):
        ...
        self.output_dir1 = "output_attach2"   
        self.output_dir2 = "output_attach3"   
        # self.output_dir = "."   # for nanoHUB

        # Define viewport ranges.
        self.vp_xmins = [0, .5]
        self.vp_xmaxs = [0.5, 1.0]
        self.vp_ymins = [0, 0]
        self.vp_ymaxs = [1, 1]
        ...
        self.output_dir_w.setText(self.output_dir1)
        if self.nanohub_flag:
    ...
    def reset_model(self):
        ...
        xml_file = Path(self.output_dir1, "initial.xml")
        ...
        tree = ET.parse(Path(self.output_dir1, "initial.xml"))
    ...
    def last_plot_cb(self, text):
        ...
        print('cwd = ',os.getcwd())
        print('self.output_dir1 = ',self.output_dir1)
    ...
    def play_plot_cb(self):
        for idx in range(1):
            ...
            # full_fname = fname
            full_fname = fname
            # xml_file = Path(self.output_dir1, base_xml_file)
            full_fname = Path(self.output_dir1, fname)
    ...
    def plot_cells3Dv1(self, frame):
        print("plot_cells3Dv1:  self.output_dir1= ",self.output_dir1)
        print("plot_cells3Dv1:  frame= ",frame)
        # xml_file = Path(self.output_dir, "output00000000.xml")
        # xml_file = "output00000000.xml"
        base_xml_file = "output%08d.xml" % frame
        print("plot_cells3Dv1: base_xml_file = ",base_xml_file)

        xml_file = Path(self.output_dir1, base_xml_file)
        print("plot_cells3Dv1: xml_file = ",xml_file)
        ...
        mcds = pyMCDS_cells(base_xml_file, self.output_dir1)  
